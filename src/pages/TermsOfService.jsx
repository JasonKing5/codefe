            ...
            <div className="min-h-screen bg-gradient-to-b from-background via-background/95 to-background/90 pt-28 pb-20">
                <div className="container mx-auto px-4 max-w-5xl">
                    ...
                    <div className="text-center mb-16 relative">
                        ...
                        {/* <div className="w-32 h-1 bg-linear-to-r from-transparent via-blue-500 to-transparent mx-auto rounded-full"></div> */}
                    </div>
                    ...
                    <div className="relative">
                        ...
                        <div className="relative bg-linear-to-br from-card/80 via-card/90 to-card border border-border/30 rounded-3xl p-10 md:p-14 shadow-2xl backdrop-blur-sm overflow-hidden">
                            ...
                            <div className="relative">
                                ...
                                <section className="mb-10">
                                    ...
                                    <div className="bg-primary/5 border border-primary/20 rounded-xl p-5">
                                        <p className="text-foreground font-medium">
                                            {t('terms_of_service.introduction.agreement')}
                                        </p>
                                    </div>
                                </section>
                                ...
                                <section className="mb-10">
                                    <h2 className="text-2xl font-bold mb-4 text-primary flex items-center gap-3">
                                        ...
                                        {t('terms_of_service.account_security.title')}
                                    </h2>
                                    <p className="text-foreground/80 mb-4">
                                        {t('terms_of_service.account_security.content')}
                                    </p>
                                    <ul className="space-y-3">
                                        {t('terms_of_service.account_security.responsibilities', { returnObjects: true }).map((item, index) => (
                                ...
                                <section className="mb-10">
                                    <h2 className="text-2xl font-bold mb-4 text-primary flex items-center gap-3">
                                        ...
                                        {t('terms_of_service.user_conduct.title')}
                                    </h2>
                                    <p className="text-foreground/80 mb-4">
                                        {t('terms_of_service.user_conduct.content')}
                                    </p>

                                    <div className="bg-red-500/5 border border-red-500/20 rounded-xl p-5 mb-4">
                                        <ul className="space-y-2">
                                            {t('terms_of_service.user_conduct.prohibited_content', { returnObjects: true }).map((item, index) => (
                                    ...
                                    <div className="bg-yellow-500/5 border border-yellow-500/20 rounded-xl p-4">
                                        <p className="text-foreground/80 text-sm">
                                            {t('terms_of_service.user_conduct.consequence')}
                                        </p>
                                    </div>
                                </section>
                                ...
                                <section className="mb-10">
                                    <h2 className="text-2xl font-bold mb-4 text-primary flex items-center gap-3">
                                        ...
                                        {t('terms_of_service.service_changes.title')}
                                    </h2>
                                    <div className="bg-yellow-500/5 border border-yellow-500/20 rounded-xl p-5">
                                        <p className="text-foreground/80">
                                            {t('terms_of_service.service_changes.content')}
                                        </p>
                                    </div>
                                </section>
                                ...
                                <section className="mb-10">
                                    <h2 className="text-2xl font-bold mb-4 text-primary flex items-center gap-3">
                                        ...
                                        {t('terms_of_service.applicable_law.title')}
                                    </h2>
                                    <p className="text-foreground/80">
                                        {t('terms_of_service.applicable_law.content')}
                                    </p>
                                </section>
                                ...
                                <section className="pt-8 border-t border-border/50">
                                    ...
                                    <div className="bg-primary/5 border border-primary/20 rounded-xl p-5 inline-block">
                                        <p className="text-foreground font-medium">
                                ...
                                <div className="mt-12 pt-8 border-t border-border/30 text-center">
                                    <p className="text-muted-foreground text-sm">
                                        {t('terms_of_service.footer_note')}
                                    </p>
                                </div>
                            </div>
                        </div>
