...
export default function SmartFinanceTool() {
  ...
  useEffect(() => {
    ...
    if (savedTransactions) {
      try {
        ...
        // 确保日期格式正确
        const transactionsWithDate = parsed.map((t) => ({
          ...t,
  ...
  // 获取分类图标
  const getCategoryIcon = (type, categoryId, marginRight) => {
  ...
  const toggleFullscreen = () => {
    const container = document.querySelector('.smart-finance-container');
